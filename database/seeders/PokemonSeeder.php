...
class PokemonSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Pokemon::create([
            'name' => 'ユキノオー',
            'description' => '万年雪が　積もる　山脈で　静かに　暮らす。　ブリザードを　発生させて　姿を　隠す。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 460,
            'image' => 'image/39.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'タチフサグマ',
            'description' => 'すさまじい　せいりょうを　もつ。　シャウトとともに　いかくするさまは　ブロッキングと　よばれている。　（『ポケットモンスター ソード』より）',
            'pokedex_number' => 862,
            'image' => 'image/41.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'サーナイト',
            'description' => 'トレーナーを　守るためなら　サイコパワーを　使いきり　小さな　ブラックホールを　作り出す。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 282,
            'image' => 'image/42.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'ヌメイル',
            'description' => '背中の　渦巻き状の　突起に　脳や　心臓など　大事な　器官が　すべて　詰まっている。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 705,
            'image' => 'image/43.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'パンプジン',
            'description' => 'まよなかに　どうたいから　ひびく　ぶきみな　なきごえは　あのよで　くるしむ　ししゃの　なきごえらしい。　（『ポケットモンスター ソード』より）',
            'pokedex_number' => 711,
            'image' => 'image/44.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'ミカルゲ',
            'description' => 'いつも　悪さばかり　していたら　不思議な　術で　本体を　要石に　縛りつけられた。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 442,
            'image' => 'image/46.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'ウインディ',
            'description' => '草原を　駆け抜ける　様子は　人々の　心を　虜にしたと　昔の　絵巻に　記されていた。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 59,
            'image' => 'image/47.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'トリトドン（にしのうみ）',
            'description' => '全身　粘液で　べとべと。　昔は　この姿の　ほうが　圧倒的に　数が　多かった。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 423,
            'image' => 'image/48.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'トリトドン（ひがしのうみ）',
            'description' => '昔は　あまり　見なかったが　今は　この姿の　トリトドンが　増えていると　漁師は　語る。　（『ポケットモンスター バイオレット』より）',
            'pokedex_number' => 423,
            'image' => 'image/49.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'エンテイ',
            'description' => 'エンテイが　ほえると　せかいの　どこかの　かざんが　ふんかすると　いわれている。　（『ポケットモンスター ブリリアントダイヤモンド・シャイニングパール』より）',
            'pokedex_number' => 244,
            'image' => 'image/51.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'ムゲンダイナ',
            'description' => 'むねの　コアが　ガラルちほうの　だいちから　わきだす　エネルギーを　きゅうしゅうして　かつどうしている。　（『ポケットモンスター ソード』より）',
            'pokedex_number' => 890,
            'image' => 'image/52.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'イーブイ',
            'description' => '不規則な　遺伝子を　持つ。　石から出る　放射線によって　体が　突然変異を　起こす。　（『ポケットモンスター バイオレット』より）',
            'pokedex_number' => 133,
            'image' => 'image/53.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'グレイシア',
            'description' => '体温を　自在に　コントロールし　大気の　水分を　凍らせて　ダイヤモンドダストを　巻き起こす。　（『ポケットモンスター スカーレット』より）',
            'pokedex_number' => 471,
            'image' => 'image/54.png'
        ]);
        ...
        Pokemon::create([
            'name' => 'マギアナ',
            'description' => '５００ねんいじょうまえに　つくられたじんぞうポケモン。　ひとの　ことばをりかいするが　しゃべれない。　（『ポケットモンスター サン』より）',
            'pokedex_number' => 801,
            'image' => 'image/57.png'
        ]);
